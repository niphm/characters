...
Place that character's plaintext Tracker, Spellbook, and compass image in a private
...
After editing either private page, double-click `Update Tidewick Vault.cmd`.
