...
"%NODE%" tools\vault-admin.mjs update-character --id tidewick --title "Tidewick Greyholt" --tracker "private-src/tidewick-greyholt-level-4.html" --spellbook "private-src/Tidewick Spells Level 4.html"
echo.
pause
